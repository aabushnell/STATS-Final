...
Moreover, for a selected word from our words list, we created the following plot showing the proportion of tweets with a that word appearing in them per state. This was done using the `state_data` defined earlier.
```{r}
selected_word_state <- ''
...
We also created the following histogram for our  
```{r}
selected_word_times <- ''
